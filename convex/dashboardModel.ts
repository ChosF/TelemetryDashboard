...
export const widgetTypeValidator = v.union(
  ...
  v.literal("session-kpis"),
  v.literal("live-gauges"),
  v.literal("speed-summary"),
  v.literal("speed-trend"),
  v.literal("acceleration-trend"),
  v.literal("speed-distribution"),
  v.literal("speed-ranges"),
  v.literal("efficiency-summary"),
  v.literal("speed-power-relationship"),
  v.literal("efficiency-trend"),
  v.literal("efficiency-by-speed"),
  v.literal("optimal-speed"),
  v.literal("power-summary"),
  v.literal("voltage-current-trend"),
  v.literal("voltage-stability"),
  v.literal("current-peaks"),
  ...
  v.literal("motor-envelope"),
  v.literal("motor-statistics"),
  v.literal("dynamics-summary"),
  v.literal("imu-sensor-trend"),
  v.literal("orientation"),
  v.literal("vibration"),
  v.literal("motion-classification"),
  v.literal("imu-axis-readout"),
  v.literal("gyroscope-detail"),
  v.literal("acceleration-detail"),
  v.literal("force-peaks"),
  v.literal("angular-histogram"),
  v.literal("gps-summary"),
  v.literal("route-map"),
  v.literal("altitude-profile"),
  v.literal("route-speed-profile"),
  v.literal("quality-overview"),
  v.literal("bridge-health"),
  v.literal("outlier-analysis"),
  v.literal("integrity-kpis"),
  v.literal("quality-trend"),
  v.literal("field-availability"),
  v.literal("raw-telemetry"),
  // Retained for v1 layouts that are expanded by the client after loading.
