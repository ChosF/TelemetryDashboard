...
export interface DashboardRuntimeApi {
    ...
    bootError: Accessor<string | null>;
    isRealtimeConnecting: Accessor<boolean>;
    connectionNote: Accessor<string | null>;
    realtimeActivity: Accessor<RealtimeActivity>;
    statusText: Accessor<string>;
    statusDetail: Accessor<string | null>;
    canRetryConnection: Accessor<boolean>;
    lastMessageLabel: Accessor<string>;
    retryConnection: () => Promise<void>;
    prewarmHistoricalMode: () => void;
}
...
const DashboardOld: Component<DashboardOldProps> = (props) => {
    ...
    props.onRuntime?.({
        ...
        canRetryConnection,
        lastMessageLabel,
        retryConnection: () => attemptRealtimeConnection(true),
        prewarmHistoricalMode,
    });

    if (props.headless) {
        return <span hidden aria-hidden="true" data-dashboard-runtime="active" />;
    }
