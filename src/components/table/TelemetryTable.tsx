...
const COLUMN_LABELS: Record<string, string> = {
    ...
    current_a: 'Current (A)',
    power_w: 'Power (W)',
    avg_power_w: 'ESP32 Avg Power (W)',
    throttle_pct: 'Throttle %',
    brake_pct: 'Brake %',
    brake2_pct: 'Brake 2 %',
    vesc_voltage_v: 'VESC Voltage (V)',
    vesc_current_a: 'VESC Current (A)',
    motor_rpm: 'Motor RPM',
    motor_temp_c: 'Motor Temperature (°C)',
    vehicle_heading: 'Vehicle Heading (°)',
    motor_phase_1_current_a: 'Phase 1 Current (A)',
    motor_phase_2_current_a: 'Phase 2 Current (A)',
    motor_phase_3_current_a: 'Phase 3 Current (A)',
    ...
    inst_eff_km_kwh: 'Instant Efficiency',
    acc_eff_km_kwh: 'Accumulated Efficiency',
    current_efficiency_km_kwh: 'Instant Efficiency (Legacy)',
    motion_state: 'Motion',
